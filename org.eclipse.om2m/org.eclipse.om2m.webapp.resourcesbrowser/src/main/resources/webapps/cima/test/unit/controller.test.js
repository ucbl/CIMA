...
describe('HomeController', function() {
    ...
    describe(' tests $interval, $watch', function() {
        var $interval,
            $httpBackend;
        ...
        // it(' test if $scope properties are changed', function() {
        //     $scope.devices.pop();
        //     $scope.useConfig = {automatic: true};
        //     $scope.useMode = {HTTP: true};
        //     $scope.useKeys = {ev3: true};
        //     $scope.$digest();
        //     //$scope.$digest();
        //     expect($scope.configGroup).toBeEmptyArray();
        // });
    });
});